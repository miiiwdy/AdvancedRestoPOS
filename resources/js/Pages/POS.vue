    ...
    <div class="flex flex-row h-screen w-full bg-[#F7F7F7] overflow-y-hidden">
        ...
        <div class="flex flex-col w-[80%] h-screen">
            ...
            <div class="flex flex-row h-auto w-full px-4 py-4 gap-4">
                ...
                <!-- Drinks -->
                <div @click="toggleActive('drinks')" :class="['flex flex-row py-3 px-3 w-48 h-20 rounded-2xl cursor-pointer',activeMenu === 'drinks' ? 'bg-[#f0f7ff] outline outline-2 outline-[#2D71F8]' : 'bg-white']">
                    ...
                    <div class="wrap flex flex-col ml-3 justify-center">
                        <div class="nama_kategori font-semibold text-lg text-gray-700">Drinks</div>
                        <div class="total_barang_in_kategori text-sm text-gray-500">3 items</div>
                    </div>
                </div>
                <!-- Dessert -->
                <div @click="toggleActive('dessert')" :class="['flex flex-row py-3 px-3 w-48 h-20 rounded-2xl cursor-pointer',activeMenu === 'dessert' ? 'bg-[#f0f7ff] outline outline-2 outline-[#2D71F8]' : 'bg-white']">
                    ...
                    <div class="wrap flex flex-col ml-3 justify-center">
                        <div class="nama_kategori font-semibold text-lg text-gray-700">Dessert</div>
                        <div class="total_barang_in_kategori text-sm text-gray-500">3 items</div>
                    </div>
                </div>
            </div>
